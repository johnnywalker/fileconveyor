...
from fileconveyor.transporters.transporter_s3 import TransporterS3
...
class TransporterCF(TransporterS3):
    ...
    def __init__(self, settings, callback, error_callback, notifier, parent_logger=None):
        return TransporterS3.__init__(self, settings, callback, error_callback, notifier, parent_logger)
